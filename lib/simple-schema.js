...
OrgJobSchema =new SimpleSchema({
  ...
  commitment: {
  	type: String,
  	allowedValues: ['full', 'part', 'project'],
    autoform: {
      options: [
...
// JobsCollection =new Meteor.Collection("jobs");

OrganizationsCollection.attachSchema(OrganizationSchema);
TagsCollection.attachSchema(TagSchema);